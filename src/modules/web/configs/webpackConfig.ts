...
async function getCssLoader(mode: "development" | "production") {
  return mode === "development"
    ? {
        loader: getToolsModulePath("typings-for-css-modules-loader"),
        options: {
          modules: true,
          namedExport: true,
          camelCase: true,
    ...
    module: {
      ...
      rules: [
        ...
        },
        {
          test: /\.css$/,
          exclude: /node_modules/,
          use: [MiniCssExtractPlugin.loader, await getCssLoader(mode)]
        },
        {
          test: /\.css$/,
